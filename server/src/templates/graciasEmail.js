...
<body style="font-family: 'Arial', sans-serif; background-color: #f4f4f4; margin: 0; padding: 0; color: #333;">
    <div style="max-width: 600px; margin: 20px auto; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
        ...
        <div style="padding: 25px; line-height: 1.6; text-align: center;">
            ...
            <p style="font-size: 16px; color: #555; margin-bottom: 20px;">Gracias por apoyar a la Fundación Sanders con tu donación de $${amount}. Tu generosidad hace posible que sigamos trabajando para llevar agua potable a las comunidades que más lo necesitan.</p>
            ...
            <div style="text-align: center; margin: 20px 0;">
                <img src="https://example.com/path-to-your-image/cover_5.jpg" alt="Fundación Sanders" style="width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.2);">
            </div>
