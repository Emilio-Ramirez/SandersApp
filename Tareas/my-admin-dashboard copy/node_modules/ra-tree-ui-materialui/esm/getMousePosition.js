 ...
 */
var getMousePosition = function (rectangle, mouseCoordinates) {
    // Get vertical middle
    var hoverMiddleY = (rectangle.bottom - rectangle.top) / 2;
    // Get pixels to the top
    var hoverClientY = mouseCoordinates.y - rectangle.top;
    var percentage = (hoverMiddleY - hoverClientY) / rectangle.height;
    var isAbove = percentage > 0.25;
    var isBelow = percentage < -0.25;
