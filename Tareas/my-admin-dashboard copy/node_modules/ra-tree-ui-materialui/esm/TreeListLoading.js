...
var TreeListLoading = function (_a) {
    ...
    return (React.createElement(List, __assign({ dense: true, disablePadding: true }, sanitizeRestProps(props)), times(nbFakeLines, function (key) { return (
    // @ts-ignore
    React.createElement(TreeNode, __assign({ key: key, record: DummyRecord }, props),
