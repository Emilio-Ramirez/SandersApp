 ...
 * );
 */
var AddChildNodeMenuItemView = function (_a) {
    var basePath = _a.basePath, _b = _a.label, label = _b === void 0 ? 'ra.tree.add_child_node' : _b, nodeChildren = _a.nodeChildren, parentSource = _a.parentSource, positionSource = _a.positionSource, parentRecord = _a.record, translate = _a.translate, props = __rest(_a, ["basePath", "label", "nodeChildren", "parentSource", "positionSource", "record", "translate"]);
    var _c;
    ...
    var record = (_c = {},
        ...
        _c[parentSource] = parentRecord.id,
        _c);
...
var mapStateToProps = function (state, props) { return ({
    nodeChildren: props.record && props.record.id
        ? getChildrenNodes(state, props.resource, props.record.id)
        : [],
}); };
var AddChildNodeMenuItem = compose(connect(mapStateToProps, {}), withTranslate)(
// @ts-ignore
